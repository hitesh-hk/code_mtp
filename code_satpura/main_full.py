...
import os
import copy
from data_loader_full import wsitxt_train
from csv_dataloader import CustomDatasetFromCSV
...
train_dataset = CustomDatasetFromCSV('data_train.csv', train_transforms)
val_dataset = CustomDatasetFromCSV('data_val.csv', train_transforms)
...
def train_model(model, criterion, optimizer, num_epochs=25):
    ...
    for epoch in range(num_epochs):
        ...
        print('TRN_ACCU', epoch_acc_train)
        print('TRN_LOSS', epoch_loss_train)
